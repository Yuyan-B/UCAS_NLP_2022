...
parser.add_argument('--lambdaB',type=float,default=0.25)
parser.add_argument('--lambdaC',type=float,default=0.25)
# ========================= Data Configs ==========================
parser.add_argument('--train_file',default='./data/starting_ki/train_all_tasks.csv')#B\C重采样：替换train_file
parser.add_argument('--test_file',default='./data/dev_task_a_entries.csv')
parser.add_argument('--val_file',default='./data/oversample_val.csv')
...
parser.add_argument('--pretrain_cache', type=str, default='/home/lyq/syh/EDOS/pretrain_model')
...
parser.add_argument('--ckpt_file', type=str, default='./save/model_roberta_epoch_3_mean_f1_0.8422.bin')
